...
developed = developed %>% select(-c('Country', 'Year', 'Status', 
...
thinness_5_9_years = coefficients['thinness.5.9.years']
diphtheria = coefficients['Diphtheria']
measles = coefficients['Measles']
alcohol = coefficients['Alcohol']
